...
LightPoint lightP0(glm::vec3(10.0f,0,0),
	glm::vec3(glm::radians(45.0f), glm::radians(45.0f), 0),
	glm::vec3(10.0f, 10.0f, 10.0f));
LightPoint lightP1(glm::vec3(5.0f,1.0f,0),
	glm::vec3(glm::radians(45.0f), glm::radians(45.0f), 0),
	glm::vec3(10.0f, 10.0f, 10.0f));
LightPoint lightP2(glm::vec3(10.0f, 0, 1.0f),
	glm::vec3(glm::radians(45.0f), glm::radians(45.0f), 0),
	glm::vec3(0, 0, 1.0f));
LightPoint lightP3(glm::vec3(5.0f, 1.0f, 1.0f),
	glm::vec3(glm::radians(45.0f), glm::radians(45.0f), 0),
